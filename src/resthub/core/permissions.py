...
PERMISSION_GROUPS: tuple[str, ...] = (_MENU, _MESAS, _PEDIDOS, _INVENTARIO, _ADMINISTRACION)
...
CATALOG: dict[Permission, PermissionInfo] = {
    ...
    Permission.ORDERS_CHARGE: PermissionInfo("Cobrar pedidos", _PEDIDOS),
...
# Lo que hace un mesero desde el celular: ver el menú y las mesas y tomar
# pedidos. Qué pedidos ve (los suyos y los de sus mesas abiertas) lo decide el
# caso de uso, no un permiso.
_WAITER = frozenset(
    {
